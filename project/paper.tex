...
Type expressions are evaluated left to right until everything is $\prim$.
{
    ...
    \begin{mathpar}
        ...
        \Rule{TSTEP}
            ...
            {\tau^* ~ \tau_1 ~ ... ~ \tau_n \tstep \tau^* ~ \tau_1' ~ ... ~ \tau_n}
        \and
    \end{mathpar}  
}
...
\subsection{Others}
{
    ...
    \begin{mathpar}
        ...
        \and \Rule{Fixed Point}{e \val \\ \tau \prim}{\kwfix{e}{\tau} \val}
    ...
    \begin{mathpar}
        ...
        \and \Rule{Fix}
            {\tau_1 \prim
                \\ \typed{\ctx}{e}{\tau_2}
                \\ \tau_2 \prim
                \\ \tau_2 = \kwArrow{\tau^*_3 ~ \kwArrow{\tau^*_3}{\tau^*_4}}{\tau^*_4}}
            {\typed{\ctx}{\kwfix{e}{\tau_1}}{\kwArrow{\tau^*_3}{\tau^*_4}}}
    \end{mathpar}
}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item (T-7)
            ...
            By induction, $e_1 \step e_1'$ or $e_1 \val$.
            If $e_1 \step e_1'$, then by \Rulename{STEP-1}, $e^* \step \kwtern{e_1'}{e_2}{e_3}$.
            
            If $e_1 \val$, then by induction, $e_2 \step e_2'$ or $e_2 \val$.
            If $e_1 \val$ and $e_2 \step e_2'$, then by \Rulename{STEP-2}, $e^* \step \kwtern{e_1}{e_2'}{e_3}$.
            
            If $e_1 \val$ and $e_2 \val$, then by induction, $e_3 \step e_3'$ or $e_3 \val$.
            If $e_1 \val$ and $e_2 \val$ and $e_3 \step e_3'$, then by \Rulename{STEP-2}, $e \step \kwtern{e_1}{e_2}{e_3'}$.
        ...
        \item \Rulename{Tuple Type}
            ...
            % Then either all elements are values or there exists some *first* steppable element
            % if there's a steppable element, then e^*_t steps using STEP-{1,2}, so e^* steps using TUPLES-1
            % if there are no steppable elements, then all elements are values, so e^* \val by TUPLES-2
    \end{itemize}
\end{proof}
